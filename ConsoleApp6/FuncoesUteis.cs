...
public class FuncoesUteis
{
    ...
    public static void DIGITEUMAOPCAOVALIDA()
    {
    ...
    public static void DIGITEUMNUMEROINTEIRO()
    {
    ...
    public static void DIGITEUMADATAVALIDA()
    {
    ...
    public static void ITEMNAOENCONTRADO()
    {
